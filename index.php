...
?>
	...
	div.main-content {
	  ...
	  <tr style='background-color:transparent;' >
		...
		<table>
			<tr>
				<td><a><?php print_lang('lang'); ?>:</a></td>
				<td><?php echo $lang_sel; ?></td>
			</tr>
			<tr>
				<td><a><?php print_lang('login'); ?>:</a></td>
				<td><input type="text" name="ulogin" id="ulogin" value="" size="20" /></td>
			</tr>
			<tr>
				<td><a><?php print_lang('password'); ?>:</a></td>
				<td style="margin-left: 43px;"><input type="password" name="upassword" value="" size="20" /></td>
			</tr>
			<?php 
			...
			<tr>
				...
				<td><a style="font-size: 15px;" href="?m=lostpwd<?php echo $lang_switch; ?>"><?php print_lang('lost_passwd'); ?></a></td>
			</tr>
		</table>
		</form>
		 </div>
		  <div class="note">
           <a>Due to security reasons, need to be in localhost to login</a>
           </div>
